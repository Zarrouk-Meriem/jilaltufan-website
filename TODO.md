...
- [ ] **P2 — Two Vercel projects build every push** (`jilaltufan-website` and `jilaltufan-website-l3o4`, both linked to the repo). Keep the one that owns the public URL and delete the other in the Vercel dashboard.
