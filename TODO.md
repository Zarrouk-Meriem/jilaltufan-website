...
- [ ] **P1 — Neon Postgres + Cloudflare R2 bucket** — the two accounts the preview needs (DEPLOY.md Path 0, steps 1 and 3). Yours to create; I take it from the connection string and keys.
