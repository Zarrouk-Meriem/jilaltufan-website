    ...
    <div className="container-site py-16">
      ...
      <Block id="colour" title={ar ? 'الألوان' : 'Colour'}>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          ...
          <div className="pattern-marks-paper rounded-brand border border-line p-8">
      ...
      <Block id="logo" title={ar ? 'الشعار والعلامة' : 'Logo & mark'}>
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="pattern-marks-navy flex flex-col items-start gap-6 rounded-brand p-8 surface-navy">
