    ...
    <div className="container-site py-16">
      ...
      <Block id="colour" title={ar ? 'الألوان' : 'Colour'}>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          <div className="rounded-brand surface-navy p-8">
          ...
          <div className="rounded-brand border border-line pattern-marks-paper p-8">
      ...
      <Block id="logo" title={ar ? 'الشعار والعلامة' : 'Logo & mark'}>
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="flex flex-col items-start gap-6 rounded-brand surface-navy p-8 pattern-marks-navy">
      ...
      <Block id="buttons" title={ar ? 'الأزرار والروابط' : 'Buttons & links'}>
        ...
        <div className="mt-4 flex flex-wrap items-center gap-3 rounded-brand surface-navy p-6">
      ...
      <Block id="loader" title={ar ? 'المُحمِّل' : 'Loader'}>
        ...
        <div className="mt-4 flex items-center gap-10 rounded-brand surface-navy p-6">
      ...
      <Block id="badges" title={ar ? 'الحالات' : 'Status badges'}>
        ...
        <div className="mt-8 flex gap-4">
          ...
          <div className="rounded-brand surface-navy p-3">
