...
- **No utility row above the header** (user feedback). The header is one row: logo · five nav items · language switch · a quiet «دخول» link to the windows (user decision, 2026-09-26) · CTA. Student/Instructor windows live in the footer, the mobile menu, and contextual links.
