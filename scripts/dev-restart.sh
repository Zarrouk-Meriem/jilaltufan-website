...
for r in "" /programs /programs/palestine-our-compass /apply /schedule /events /events/jeel-altoufan-camp /projects /about /about/structure /students /instructors /knowledge /knowledge/minbar /knowledge/materials /contact /privacy /terms /account /account/application /account/sessions /account/materials /account/profile /account/sign-in /account/forgot /account/set-password /application/warm-the-route; do
